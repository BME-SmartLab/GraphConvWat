...
#		python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy $deploy --wds ctown --obsrat 0.05 --batch 120
...
#for idx in {1..3}
#do
#	python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy hds --wds anytown --obsrat 0.1 --aversion 1 --batch 200
#	python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy hds --wds ctown --obsrat 0.05 --aversion 5 --batch 120
#	python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy hds --wds richmond --obsrat 0.05 --aversion 7 --batch 50
#done
#for idx in {1..15}
#do
#	python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy random --wds anytown --obsrat 0.1 --batch 200
#	python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy random --wds ctown --obsrat 0.05 --batch 120
#	python test_Taylor_metrics_for_sensor_placement.py --runid $idx --adj binary --tag placement --deploy random --wds richmond --obsrat 0.05 --batch 50
#done
