...
for idx in {1..15}
do
	python test_Taylor_metrics_for_sensor_placement.py --wds anytown --obsrat 0.1 --adj binary --tag placement --runid $idx --deploy hdsrnd --deterministic
	python test_Taylor_metrics_for_sensor_placement.py --wds ctown --obsrat 0.05 --adj binary --tag placement --runid $idx --deploy hdsrnd --deterministic
	python test_Taylor_metrics_for_sensor_placement.py --wds richmond --obsrat 0.05 --adj binary --tag placement --runid $idx --deploy hdsrnd --deterministic
done
