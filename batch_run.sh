...
for idx in {1..15}
do
	python train.py --epoch 1000 --adj binary --tag ms --deploy random --deterministic --wds anytown --budget 1 --batch 200
	python train.py --epoch 1000 --adj binary --tag ms --deploy random --deterministic --wds ctown --budget 5 --batch 120
	python train.py --epoch 1000 --adj binary --tag ms --deploy random --deterministic --wds richmond --budget 10 --batch 50
done
